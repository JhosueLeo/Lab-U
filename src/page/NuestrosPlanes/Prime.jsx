...
import genxprime from "../../img/genxprime.svg";
...
import styles from "../../css/Prime.module.css";
  ...
  return (
    <div>
      <div className={styles.img}>
        <img className={styles.baner} src={genxprime} alt="BanerXPlus" />
      </div>
      <div className={styles.plan}>
        <p className={styles.text_prime}>
          <b>Plan Gen </b>
          <img className="x" src={x} alt="" /> Prime
        </p>
      </div>
        ...
        <div className={styles.Info2}>
          ...
          <div className={styles.info}>
            ...
            <p className={styles.info2}>
              Nuestro segundo plan cuenta con 23 enfermedades por ser analizadas
            </p>
          </div>
        </div>
        <div className={styles.cards}>
          ...
          <div className={styles.cards3}>
            ...
            <div className={styles.card5}>
              ...
              <p className={styles.dat1}>Neurofibromatosis tipo 2</p>
            </div>
