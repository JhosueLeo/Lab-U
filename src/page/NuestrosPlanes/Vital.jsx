...
import styles from "../../css/Vital.module.css";
import genxvital from "../../img/genxvital.svg";
  ...
  return (
    <div>
      <div className={styles.img}>
        <img className={styles.baner} src={genxvital} alt="BanerXvital" />
      ...
      <div className={styles.plan}>
        <p className={styles.text}>
          <b>Plan Gen </b>
          <img className={styles.x} src={x} alt="" /> Vital
        </p>
      </div>
        ...
        <div className={styles.Info2}>
          ...
          <div className={styles.info}>
            ...
            <p className={styles.info2}>
              Nuestro Plan Gen X vital es exclusivo para menores de30 años.
              Dentro de ello el plan vital comprende todas lasenfermedades del
              plan ultra + 5 enfermedades más.
            </p>
          </div>
        </div>
        <div className={styles.cards}>
          <div className={styles.card1}>
            ...
            <ul className={styles.dat}>
              ...
              <li className={styles.dato}>
                <div className={styles.dot}></div>Sindrome mielodisplásico
              </li>
              <li className={styles.dato}>
              ...
              <li className={styles.dato}>
                <div className={styles.dot}></div>Melanoma
              </li>
              <li className={styles.dato}>
                <div className={styles.dot}></div>Retinoblastoma
              </li>
              <li className={styles.dato}>
                <div className={styles.dot}></div>Síndrome de poliposis juvenil
              </li>
            </ul>
          </div>
          ...
          <div>
            <div className={styles.card3}>
              ...
              <ul className={styles.dat}>
                <li className={styles.dato}>
                  <div className={styles.dot}></div>Porfiria Aguda Intermite
                </li>
                <li className={styles.dato}>
                  <div className={styles.dot}></div>Diabetes Monogénica
                </li>
              </ul>
            </div>
            <div className={styles.card7}>
              ...
              <ul className={styles.dat}>
                <li className={styles.dato}>
                  <div className={styles.dot}></div>Enfermedad de Wilson
                </li>
                <li className={styles.dato}>
                  <div className={styles.dot}></div>Enfermedad de Pompe
                </li>
              </ul>
            </div>
            ...
            <div className={styles.card6}>
              ...
              <ul className={styles.dat}>
                <li className={styles.dato}>
                  <div className={styles.dot}></div>Hipertermia Maligna
                </li>
              </ul>
            </div>
          </div>
